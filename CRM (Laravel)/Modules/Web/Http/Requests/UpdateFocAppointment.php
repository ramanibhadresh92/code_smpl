...
class UpdateFocAppointment extends FormRequest
{
    /**
    ...
    public function withValidator($validator)
    {
        $validator->after(function ($validator) {
            ...
            if (strtotime($this->app_date_time) < strtotime($date)) {
                if ($this->para_status_id != APPOINTMENT_CANCELLED && $this->para_status_id != APPOINTMENT_DELETED) {
					$this->error[] = "Appointment Cannot be Set for Past Date.";
				}
