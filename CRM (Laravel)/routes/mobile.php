...
use Modules\Mobile\Http\Controllers\CustomerController as CustomerController;
...
Route::namespace('Modules\Mobile\Http\Controllers')->group(function () { 
    Route::post('/v1/user/bams/login', [LoginController::class,'BamsLogin']);
    Route::post('/v1/user/login', [LoginController::class,'login'])->middleware(['versionCheck','localization']); 
    Route::post('/v1/checkVersionUpdate', [LoginController::class,'checkVersionUpdate'])->middleware(['localization']); 
    Route::post('/v1/GetAwsSettings', [LoginController::class,'GetAwsSettings'])->middleware(['localization']); 
});

Route::namespace('Modules\Mobile\Http\Controllers')->group(function () { 
    Route::post('/v1/corporate/login', [LoginController::class,'CorporateLogin'])->middleware(['localization'])->name('corporate-login'); 
    Route::post('/v1/corporate/register', [LoginController::class,'CorporateRegister'])->middleware(['localization'])->name('corporate-register'); 
    Route::post('/v1/corporate/forgotpass', [LoginController::class,'CorporateForgotPass'])->middleware(['localization'])->name('corporate-forgotpass');
});

Route::namespace('Modules\Mobile\Http\Controllers')->group(function () { 
    Route::post('/v1/client/login', [ClientController::class,'ClientLogin'])->middleware(['localization'])->name('client-login'); 
    Route::post('/v1/client/register', [ClientController::class,'ClientRegister'])->name('client-register'); 
    Route::post('/v1/client/city-list', [ClientController::class,'ListCity'])->middleware(['localization'])->name('city-list'); 
    Route::post('/v1/client/state-list', [ClientController::class,'ListState'])->middleware(['localization'])->name('state-list'); 
    Route::post('/v1/client/verify-otp', [ClientController::class,'VerifyOTP'])->middleware(['localization'])->name('VerifyOTP');
    Route::post('/v1/client/verify-mobile', [ClientController::class,'VerifyMobile'])->middleware(['localization'])->name('VerifyMobile');
    Route::post('/v1/client/resend-auth-otp',['middleware' => 'throttle:1,5','uses' => [ClientController::class,'ResendAuthOTP']])->middleware(['localization'])->name('ResendAuthOTP');
    Route::post('/v1/client/client-check-version', [ClientController::class,'ClientCheckVersion'])->middleware(['localization'])->name('client-check-version'); 
});

Route::namespace('Modules\Mobile\Http\Controllers')->group(function () { 
    Route::post('/v1/GetStateList', [CustomerController::class,'GetStateList'])->middleware(['localization'])->name('GetStateList'); 
    Route::post('/v1/GetCityList', [CustomerController::class,'GetCityList'])->name('GetCityList'); 
});
...
Route::group(['middleware' => ['localization','assign.guard','cors'], 'prefix' => $PRIFIX, 'namespace' => 'Modules\Mobile\Http\Controllers'], function() {
    Route::group(['prefix' =>'user'], function() {
        ...
        Route::post('create-customer-address',[CustomerController::class,'createCustomerAddress'])->name('createCustomerAddress');
        Route::post('update-customer-address',[CustomerController::class,'updateCustomerAddress'])->name('updateCustomerAddress');
        Route::post('customer-address-list',[CustomerController::class,'CustomerAddresslist'])->name('CustomerAddressList');
        Route::post('customerwise-address-list',[CustomerController::class,'CustomerWiseAddresslist'])->name('CustomerWiseAddressList');
        Route::post('addressgetById',[CustomerController::class,'AddressGetById'])->name('customer-address-detail');
        Route::post('CustomerAddressDropDown',[CustomerController::class,'CustomerAddressDropDown'])->name('CustomerAddressDropDown');
        Route::post('pricegroup-getby-customerid',[CustomerController::class,'PriceGroupGetByCustomerId'])->name('pricegroup-getby-customerid');
        Route::post('update-customer-pricegroup-product',[CustomerController::class,'UpdateCustomerPriceGroupProduct'])->name('update-customer-pricegroup-product');
    });
...
Route::group(['middleware' => ['localization','assign.guard','cors'], 'prefix' => $PRIFIX, 'namespace' => 'Modules\Web\Http\Controllers'], function() {
 ...
 Route::group(['prefix' =>'client'], function()
    {
       Route::post('logout', [ClientController::class,'ClientLogout'])->name('client-logout');
        ...
        /* START HDFC Payment Block By Bhadresh Ramani */
        
        Route::post('invoice/initiatePayment4Mobile',[InvoiceMasterController::class,'InitiatePayment4Mobile'])->name('InitiatePayment4Mobile');

        Route::post('invoice/getPaymentStatus',[InvoiceMasterController::class,'GetPaymentStatus'])->name('GetPaymentStatus');

        Route::post('invoice/getresponce',[InvoiceMasterController::class,'getResponce'])->name('getResponce');

        Route::post('invoice/getPaymentResponce4mobile',[InvoiceMasterController::class,'GetPaymentResponce4mobile'])->name('getPaymentResponce4mobile');
        /* END HDFC Payment Block By Bhadresh Ramani */  
    });
});