...
class UpdateAvgPriceDailyBasisForSalesStock extends Command
{
	/**
	 ...
	 * @var string
	 */
	protected $signature = 'UpdateAvgPriceDailyBasisForSalesStock';
	...
	public function handle()
	{
		...
		try{
			...
			\Log::info("ERROR CRON UpdateAvgPriceDailyBasisForSalesStock ".$e->getMessage());
		}
	}
}