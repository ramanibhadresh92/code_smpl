...
class ImportGhostAppointment2 extends Command
{
	/**
	 ...
	 * @var string
	 */
	protected $signature = 'ImportGhostAppointment2';
	 ...
	 * @var string
	 */
	protected $description = 'Console To Import Ghost Appointment For Custom Products';
	...
	public function handle()
	{
		...
		$CSV_File_Name 		= "CUS-6-JUL-2020-AUG-2020.csv";
		$ImportID 			= "20200701";
		...
		if (file_exists($SERVER_FILE_PATH))
		{
			...
			while (!feof($file_handle))
			{
				...
				if($no_of_lines > 0)
				{
					if(!empty($line_of_text[0]) && !empty($line_of_text[5]) && !empty($line_of_text[10]))
					{
