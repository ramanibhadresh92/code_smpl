...
use DateInterval;
use DatePeriod;
class UpdateAvgPricePurchaseForYear2022And2023 extends Command
{
	/**
	 ...
	 * @var string
	 */
	protected $signature = 'UpdateAvgPricePurchaseForYear2022And2023';
	...
	public function handle()
	{
		...
		try{
			...
			\Log::info("ERROR CRON UpdateAvgPricePurchaseForYear2022And2023 ".$e->getMessage());
		}
	}
}