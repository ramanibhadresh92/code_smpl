...
class CustomerAddRequest extends FormRequest
{
    ...
    public function rules()
    {
        return [
            ...
            // 'appointment_type'      => 'in:0,1,2,3,99',
            // 'appointment_date'      => 'required',
            // 'appointment_time'      => 'sometimes',
            // 'appointment_on'        => 'required',
            'para_payment_mode_id'  =>  'required|exists:parameter,para_id',
            'gst_no'                => "nullable|unique:customer_master,gst_no",
            'pan_no'                => "nullable|unique:customer_master,pan_no"
    ...
    public function withValidator($validator)
    {
        $validator->after(function ($validator) {
            ...
            if ($this->ctype != CUSTOMER_TYPE_BOP ) {
                ...
                $validator->errors()->add('mobile_no', 'Mobile number field is required.');
                }
            }
