...
class UpdateDailyProjectionPlanDetails extends FormRequest
{
	/**
	...
	{
		return ['id' 							=> "required|exists:wm_daily_projection_plan_details,id",
				'wm_daily_projection_plan_id' 	=> "required|exists:wm_daily_projection_plan,id",
