...
use frontend\models\LocalguideReview;
...
class LocalguideController extends Controller
{
   public function behaviors()
    ...
    public function actionIndex() {
        ...
        $posts = LocalguidePost::recentLocalguidePosts($user_id);
        ...
        if(isset($user_id) && $user_id != '') {
            ...
            if($checkuserauthclass != 'checkuserauthclassg' && $checkuserauthclass != 'checkuserauthclassnv') {        
                if(isset($_POST) && !empty($_POST)) {
                    $post = $_POST;
                    $files = $_FILES;
                    $result = LocalguidePost::createpost($post, $files, $user_id);
                    return $result;
                    exit;
                }
            }
        ...
        if(isset($user_id) && $user_id != '') {
            ...
            if($checkuserauthclass != 'checkuserauthclassg' && $checkuserauthclass != 'checkuserauthclassnv') {        
                if(isset($_POST) && !empty($_POST)) {
                    $post = $_POST;
                    $files = $_FILES;
                    $result = LocalguidePost::editpost($post, $files, $user_id);
                    return $result;
                    exit;
                }
            }
    ...
    public function actionUploadphotoslocalguidesave() {
        $session = Yii::$app->session;
        $user_id = (string)$session->get('user_id');
        ...
        if(isset($user_id) && $user_id != '') {
            ...
            if($checkuserauthclass != 'checkuserauthclassg' && $checkuserauthclass != 'checkuserauthclassnv') {        
                if(isset($_POST) && !empty($_POST)) {
                    $post = $_POST;
                    $files = $_FILES;
                    $result = LocalguidePost::uploadphotoslocalguidesave($post, $files, $user_id);
                    return $result;
                    exit;
                }
            }
    ...
    public function actionRecentLocalguidePosts() {
        $session = Yii::$app->session;
        $user_id = (string)$session->get('user_id');
        ...
        if(isset($user_id) && $user_id != '') {
            $checkuserauthclass = UserForm::isUserExistByUid($user_id);
            $posts = LocalguidePost::recentLocalguidePosts($user_id,$start);
        } else {
            $checkuserauthclass = 'checkuserauthclassg';
            $posts = LocalguidePost::recentLocalguidePosts($start);
        }
    ...
    public function actionSelectedRecord() {
        ...
        if(isset($_POST['$id']) && $_POST['$id'] != '') {
            if(isset($_POST['$address']) && $_POST['$address'] != '') {
                ...
                if(isset($user_id) && $user_id != '') {
                    $checkuserauthclass = UserForm::isUserExistByUid($user_id);
                    $posts = LocalguidePost::selectedrecord($id, $address, $user_id);
                } else {
                    $checkuserauthclass = 'checkuserauthclassg';
                    $posts = LocalguidePost::selectedrecord($id, $address);
                }
    ...
    public function actionMyposts() {
        ...
        if(isset($user_id) && $user_id != '') {
            $checkuserauthclass = UserForm::isUserExistByUid($user_id);
            if($checkuserauthclass != 'checkuserauthclassg' && $checkuserauthclass != 'checkuserauthclassnv') {
                $posts = LocalguidePost::myposts($user_id);
                $posts = json_decode($posts, true); 
            }
        } else {
            $checkuserauthclass = 'checkuserauthclassg';
    ...
    public function actionEditpostpopupopen() {
        ...
        if(isset($user_id) && $user_id != '') {
            ...
            if($checkuserauthclass != 'checkuserauthclassg' && $checkuserauthclass != 'checkuserauthclassnv') {
                if(isset($_POST['id']) && $_POST['id'] != '') { 
                    $id = $_POST['id'];
                    return $this->render('edit_post_popup', array('checkuserauthclass' => $checkuserauthclass, 'id' => $id));
                }
            }
        }
    }

    public function actionUploadphotoslocalguide() {
        $session = Yii::$app->session;
        $user_id = (string)$session->get('user_id');
        ...
        if(isset($user_id) && $user_id != '') {
            ...
            if($checkuserauthclass != 'checkuserauthclassg' && $checkuserauthclass != 'checkuserauthclassnv') {
                if(isset($_POST['id']) && $_POST['id'] != '') { 
                    $id = $_POST['id'];
                    return $this->render('uploadphotoslocalguide', array('checkuserauthclass' => $checkuserauthclass, 'id' => $id));
                }
            }
        }
    }
    ...
    public function actionSearch() {
        ...
        if(isset($_POST) && !empty($_POST)) {
            ...
            if(isset($user_id) && $user_id != '') {
                $checkuserauthclass = UserForm::isUserExistByUid($user_id);
                $posts = LocalguidePost::search($post, $user_id);
            } else {
                $checkuserauthclass = 'checkuserauthclassg';
                $posts = LocalguidePost::search($post);
            }
        }
    ...
    public function actionSendInvitePost() {
        ...
        if(isset($user_id) && $user_id != '') {
            ...
            if($checkuserauthclass != 'checkuserauthclassg' && $checkuserauthclass != 'checkuserauthclassnv') {        
                if(isset($_POST) && !empty($_POST)) {
                    $post = $_POST;
                    $sendpost = LocalguidePostInvite::sendinvitepost($post, $user_id);
                    return $sendpost;
                    exit;
                }
            }
    ...
    public function actionSavePost() {
        ...
        if(isset($user_id) && $user_id != '') {
            ...
            if($checkuserauthclass != 'checkuserauthclassg' && $checkuserauthclass != 'checkuserauthclassnv') {        
                if(isset($_POST['$id']) && $_POST['$id'] != '') {
                    $id = $_POST['$id'];
                    $result = LocalguidePost::savepost($id, $user_id);
                    return $result;
                    exit;
                }
            }
    ...
    public function actionSaveEvent() {
        ...
        if(isset($user_id) && $user_id != '') {
            ...
            if($checkuserauthclass != 'checkuserauthclassg' && $checkuserauthclass != 'checkuserauthclassnv') {
                if(isset($_POST['$id']) && $_POST['$id'] != '') { 
                    $id = $_POST['$id']; 
                    $result = TravelSavePost::localguidesaveevent($id, $user_id);
                    return $result;
                    exit;
                }
            }
    ...
    public function actionDeletePost() {
        ...
        if(isset($user_id) && $user_id != '') {
            ...
            if($checkuserauthclass != 'checkuserauthclassg' && $checkuserauthclass != 'checkuserauthclassnv') {        
                if(isset($_POST['$id']) && $_POST['$id'] != '') {
                    $id = $_POST['$id'];
                    $result = LocalguidePost::deletepost($id, $user_id);
                    return $result;
                    exit;
                }
            }
    ...
    public function actionBlockUserPost() {
        ...
        if(isset($user_id) && $user_id != '') {
            ...
            if($checkuserauthclass != 'checkuserauthclassg' && $checkuserauthclass != 'checkuserauthclassnv') {        
                if(isset($_POST['$id']) && $_POST['$id'] != '') {
                    $id = $_POST['$id'];
                    $result = LocalguidePost::blockuserpost($id, $user_id);
                    return $result;
                    exit;
                }
            }
    ...
    public function actionUnsavePost() {
        ...
        if(isset($user_id) && $user_id != '') {
            ...
            if($checkuserauthclass != 'checkuserauthclassg' && $checkuserauthclass != 'checkuserauthclassnv') {        
                if(isset($_POST['$id']) && $_POST['$id'] != '') {
                    $id = $_POST['$id'];
                    $result = LocalguidePost::unsavepost($id, $user_id);
                    return $result;
                    exit;
                }
            }
    ...
    public function actionRequestsList() {
        ...
        if(isset($user_id) && $user_id != '') {
            ...
            if($checkuserauthclass != 'checkuserauthclassg' && $checkuserauthclass != 'checkuserauthclassnv') {
                $model = new \frontend\models\LocalguidePostInvite(); 
                                ...
                                <span class="trip-duration">
                                    ...
                                    <div class="settings-icon">
                                        ...
                                        <ul id="'.$uniqid.'" class="dropdown-content custom_dropdown">
                                            <li><a href="javascript:void(0)" onclick="deleteofferlocalguide(\''.$invitationId.'\', this)">Delete this request</a></li>
                                            <li><a href="javascript:void(0)" onclick="actionBlockUserforPost(\''.$post_id.'\')">Block this person</a></li>
                                            <li onclick="localguidereporttoabuse(\''.$invitationId.'\')"><a href="javascript:void(0)">Report this request</a></li>
                                        </ul>
                                    </div>
                                </span>
                                ...
                                <div class="offer-conversation">
                                    <div class="add-offer">
                                        ...
                                        <div class=" fullwidth tt-holder">
                                            <textarea maxlength="70" class="materialize-textarea mb0 md_textarea descinput" id="localguidedetailmessage" placeholder="Write a message..."></textarea>
                                            <a href="javascript:void(0)" onclick="sendmessagelocalguide(\''.$invitationId.'\')" class="btn-custom manage-btn">Send</a>
                                        </div>        
                                    </div>
     ...
     public function actionFetchMsgHistory() {
        ...
        if(isset($user_id) && $user_id != '') {
            ...
            if($checkuserauthclass != 'checkuserauthclassg' && $checkuserauthclass != 'checkuserauthclassnv') {        
                ...
                if(isset($_POST['$id']) && $_POST['$id'] != '') {
                    $invitationId = $_POST['$id'];
                    $history = LocalguidePostInviteMsgs::fetchmsghistory($invitationId, $user_id);
        ...
        if(isset($user_id) && $user_id != '') {
            ...
            if($checkuserauthclass != 'checkuserauthclassg' && $checkuserauthclass != 'checkuserauthclassnv') {        
                if(isset($_POST['invitationId']) && $_POST['invitationId'] != '') {
                    ...
                    $result = LocalguidePostInviteMsgs::sendmessage($post, $user_id);
                    return $result;
                }
            }
        }
    ...
    public function actionInvitationIsread() {
        ...
        if(isset($user_id) && $user_id != '') {
            ...
            if($checkuserauthclass != 'checkuserauthclassg' && $checkuserauthclass != 'checkuserauthclassnv') {        
                if(isset($_POST['$id']) && $_POST['$id'] != '') {
                    $id = $_POST['$id'];
                    $result = LocalguidePostInviteMsgs::invitationisread($id, $user_id);
                    return $result;
                    exit;
                }
            }
    ...
    public function actionDeleteOffer() {
        ...
        if(isset($user_id) && $user_id != '') {
            ...
            if($checkuserauthclass != 'checkuserauthclassg' && $checkuserauthclass != 'checkuserauthclassnv') {        
                if(isset($_POST['$id']) && $_POST['$id'] != '') {
                    $id = $_POST['$id'];
                    $result = LocalguidePostInviteMsgs::deleteoffer($id, $user_id);
                    return $result;
                    exit;
                }
            }
    ...
    public function actionBlockEventRequestUser() {
        ...
        if(isset($user_id) && $user_id != '') {
            ...
            if($checkuserauthclass != 'checkuserauthclassg' && $checkuserauthclass != 'checkuserauthclassnv') {        
                if(isset($_POST['$id']) && $_POST['$id'] != '') {
                    $id = $_POST['$id'];
                    $result = LocalguidePostInviteMsgs::blockeventrequestuser($id, $user_id);
                    return $result;
                    exit;
                }
            }
    ...
    public function actionGetLstMsg() {
        ...
        if(isset($user_id) && $user_id != '') {
            ...
            if($checkuserauthclass != 'checkuserauthclassg' && $checkuserauthclass != 'checkuserauthclassnv') {        
                if(isset($_POST['$id']) && $_POST['$id'] != '') {
                    $id = $_POST['$id'];
                    $result = LocalguidePostInviteMsgs::getLstMsg($id, $user_id);
                    return $result;
                    exit;
                }
            }
    ...
    public function actionDeleteMyPost() {
        ...
        if(isset($user_id) && $user_id != '') {
            ...
            if($checkuserauthclass != 'checkuserauthclassg' && $checkuserauthclass != 'checkuserauthclassnv') {        
                if(isset($_POST['$id']) && $_POST['$id'] != '') {
                    $id = $_POST['$id'];
                    $result = LocalguidePost::deletemyevent($id, $user_id);
                    return $result;
                    exit;
                }
            }
    ...
    public function actionSavedEventList() {
        ...
        if(isset($user_id) && $user_id != '') { 
            $checkuserauthclass = UserForm::isUserExistByUid($user_id);
            if($checkuserauthclass != 'checkuserauthclassg' && $checkuserauthclass != 'checkuserauthclassnv') {
                $posts = LocalguidePost::savedpostlist($user_id); 
                $posts = json_decode($posts, true);
    ...
    public function actionDeleteMessage() {
        ...
        if(isset($user_id) && $user_id != '') { 
            ...
            if($checkuserauthclass != 'checkuserauthclassg' && $checkuserauthclass != 'checkuserauthclassnv') {
                if(isset($_POST['$id']) && $_POST['$id'] != '') {
                    $id = $_POST['$id'];
                    $record = LocalguidePostInviteMsgs::find()->where([(string)'_id' => $id])->one();
                    if(!empty($record)) {
                        $record->delete();
                        return true;
                    }
    ...
    public function actionAddreview() {
        ...
        if(isset($userid) && $userid != '') {
            ...
            if($authstatus == 'checkuserauthclassg' || $authstatus == 'checkuserauthclassnv') {
                ...
                $lasting = LocalguideReview::find()->where([(string)'_id' => $last_insert_id])->one();
                if(!empty($lasting)) {
