...
class TripstoryController extends Controller
{
    ...
    public function actionIndex()  
    {
        ...
        $alltripexps = PostForm::getTripexpallPosts();
        return $this->render('index',array('alltripexps'=>$alltripexps, 'checkuserauthclass' => $checkuserauthclass,'place' => $place,'placetitle' => $placetitle,'placefirst' => $placefirst,'lat' => $lat,'lng' => $lng));
    }
}
?>