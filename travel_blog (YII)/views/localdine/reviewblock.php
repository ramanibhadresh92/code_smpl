...
<div class="hidden_header">
	<div class="content_header">
		...
		<a type="button" class="post_btn action_btn post_btn_xs waves-effect" onclick="addLocaldineReview()">Post</a>
	</div>
</div>					
	...
	<div class="post-bcontent">
		...
		<div class="post-bholder">
			...
			<div class="hidden_xs">
				...
				<a href="javascript:void(0)" class="mainbtn btngen-center-align btn-flat waves-effect btn-flat  submit" onclick="addLocaldineReview()">Post</a>
			</div>
		</div>
	</div> 
</div>	
