...
<script src="<?=$baseUrl?>/js/chart.js"></script>
    <div class="page-wrapper place-wrapper mainfeed-page  hidemenu-wrapper show-sidebar localdine-page"> 
			         ...
			         <div class="hcontent-holder home-section gray-section tours-page tours dine-local dine-inner-pages">
			            <div class="container mt-10">
			               <div class="tours-section">
			                     ...
			                     <div class="ml-auto">
			                        <a href="javascript:void(0)" class="createlocaldine <?=$checkuserauthclass?>">
			                  ...
			                  <div class="new-post-mobile clear createlocaldine <?=$checkuserauthclass?>">
