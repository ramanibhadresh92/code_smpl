...
<div class="row cshfsiput cshfsi">
	<div class="social-section profile-box detailBox">
		...
		<div class="item titlelabel user-info askdetailBox">
        	<p class="center-align u-name mb0">Ask for <?=$placefirst?> (<span class="count">&nbsp;</span>)</p>
	...
	<div class="postBox">
		<div class="content-box">
			<div class="new-post base-newpost cshfsiput cshfsi compose_newask">
