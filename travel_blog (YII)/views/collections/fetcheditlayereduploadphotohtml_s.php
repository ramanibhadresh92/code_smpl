...
if(!empty($collections)) {
    ...
    <div class="modal_content_container" data-editid="<?=$id?>">
        <div class="modal_content_child modal-content">
            <div class="popup-title">
                ...
                <h3>Edit collection k</h3>
                <span class="mobile_loader loaderball"><img src="<?=$baseUrl?>/images/home-loader.gif"/></span>
                <a type="button" class="item_done crop_done hidden_close_span custom_close waves-effect" href="javascript:void(0)" data-editid="<?=$id?>" onclick="uploadtempedit_ps(this)">Done</a>
            </div>
    ...
    <div class="valign-wrapper additem_modal_footer modal-footer">
        ...
        <a href="javascript:void(0)" class="btngen-center-align waves-effect" data-editid="<?=$id?>" onclick="uploadtempedit_ps(this)">Update</a>
    </div>
    <?php 
}
exit;
