...
<script src="<?=$baseUrl?>/js/chart.js"></script>
				                            ...
				                            <div class="row cshfsiput cshfsi">
												...
												<div class="postBox">
													<div class="content-box">
														<div class="new-post base-newpost cshfsiput cshfsi compose_newask <?=$checkuserauthclass?>">
																...
																foreach($getpplacereviews as $post) {
																	if(($lpDHSU%8) == 0) {  
																		...
																		if(isset($ads) && !empty($ads))
																		{
																			...
																			$this->context->display_last_ask($ad_id, $existing_posts, '', $cls,'','','',$lpDHSU);
																		}
																	}
																	$this->context->display_last_ask($post['_id'],'from_save','','reviewpost-holder bborder ');
																	$lpDHSU++;
																}
															} else { ?>
															<?php $this->context->getnolistfound('becomefirstforask'); ?>
																<?php /*<div class="no-listcontent">Become a first to ask a question for <?=$placefirst?> place</div> */ ?>
															<?php } ?>
														</div>
													</div>
												</div>
    ...
    <div id="compose_newtrip" class="modal compose_tool_box post-popup custom_modal main_modal new-wall-post set_re_height loadermodal"></div>
	...
	<div id="compose_newask" class="modal compose_tool_box post-popup custom_modal main_modal new-wall-post set_re_height compose_newask_popup"></div>
	...
	<script src="<?=$baseUrl?>/js/questions.js"></script>
	<?php $this->endBody() ?> 