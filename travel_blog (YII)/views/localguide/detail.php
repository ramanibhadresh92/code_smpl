...
$LocalguidePost = LocalguidePost::find()->where([(string)'_id' => $id])->andWhere(['not','flagger', "yes"])->asarray()->one();
$images = isset($LocalguidePost['images']) ? $LocalguidePost['images'] : '';
$images = explode(',', $images);
$defaultImages = array($baseUrl.'/images/guide-detail1.jpg', $baseUrl.'/images/guide-detail2.jpg', $baseUrl.'/images/guide-detail3.jpg');

$filter_images = array_merge($images, $defaultImages);
$filter_images = array_values(array_filter($filter_images));

//$title = $LocalguidePost['title'];
$activity = $LocalguidePost['activity'];
$activity = str_replace(',', ', ', $activity);
$licensed = $LocalguidePost['licensed'];
$description = $LocalguidePost['description'];
$credentials = $LocalguidePost['credentials'];
$restriction = $LocalguidePost['restriction'];
$language = $LocalguidePost['language'];
$guideFee = $LocalguidePost['guideFee'];
$created_at = $LocalguidePost['created_at']; 
$post_user_id = $LocalguidePost['user_id'];
...
<script src="<?=$baseUrl?>/js/chart.js"></script>
    <div class="page-wrapper mainfeed-page localguide-detail-page"> 
		                        ...
		                        <div class="row mx-0">
		                           <div class="col m8 s12">
		                              ...
		                              <div class="detail-title-container">
		                                 <h3 class="event-detail-title">Meet Your Guide</h3>
		                              </div>
		                              ...
		                              <div class="photo-section mt-20">
		                                 <div class="row mx-0 valign-wrapper">
		                                    ...
		                                    <div class="right ml-auto">
												<?php if($isvisible == 'yes') { ?>
												<a href="javascript:void(0)" class="<?=$checkuserauthclass?>" onclick="uploadphotoslocalguide('<?=$id?>', this)">+ Upload</a>
												<?php } ?>
		                                    </div>
		                                 </div>
		                                 <div class="row mt-10">
		                              ...
		                              <div class="event-right-wrapper">
		                                 <div class="booking-form-section">
		                                    <div class="price-container">
		                                       <span><span class="price"> <?=$guideFee?> </span> per day</span>
		                                    </div>
		                                    ...
		                                    <div class="btn-sec">
		                                       <a class="waves-effect waves-light btn" href="javascript:void(0)">Message to Guide</a>
		                                    </div>
		                                 </div>
		                                 <div class="contact-host valign-wrapper">
		                                    <span><i class="mdi mdi-comment-outline"></i> Questions? </span>
		                                    <a href="">Contact the guide</a>
		                                 ...
		                                 <div class="request-work">
		                                    ...
		                                    <p>
		                                       ...
		                                       <span>Suggest a date for your trip to the guide. Select how many guests you would like to bring.</span>
		                                    </p>
		                                    <p>
		                                       <i class="mdi mdi-account-multiple-outline mdi-17px"></i></i>
		                                       <span>After clicking "Message to guide", the host will then message you about availabilty. You will not be charged to send a request. </span>
		                                    </p>
		                                 </div>  
		                              </div>
		                           </div>
	...
	<div id="uploadphotosLocalGuideModal" class="modal tbpost_modal custom_modal split-page main_modal cust-pop dicrease-popup-compose event-detail-modal">
	</div>

	<div id="localguide_review" class="modal compose_tool_box post-popup custom_modal main_modal new-wall-post set_re_height compose_newreview_popup"></div>
