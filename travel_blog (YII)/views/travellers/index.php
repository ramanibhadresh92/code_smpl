...
<script src="<?=$baseUrl?>/js/chart.js"></script>
    <div class="page-wrapper place-wrapper mainfeed-page"> 
		...
		<div>
			...
			<div class="fixed-layout">
				<div class="main-content main-page places-page travellers-page pb-0 m-t-50">
			                  ...
			                  <div class="tab-content">
			                     <div id="places-travellers" class="placestravellers-content subtab bottom_tabs">
			                        <div class="content-box">
			                           ...
			                           <div class="left">
			                              <h3 class="heading-inner mt-0"><?=$placefirst?> TRAVELLERS <span class="lt"></span></h3>
			                              <p class="para-inner">People travelling to <?=$placefirst?></p>
			                           </div>
    ...
    <script src="<?=$baseUrl?>/js/travellers.js"></script>
    <?php $this->endBody() ?> 