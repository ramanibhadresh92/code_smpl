    ...
    <div class="npost-content">
        ...
        <div class="post-bcontent">
            <div class="post-toolbox">
                <?php /*<a href="javascript:void(0)" class="add-photos">
				...
				<?php /*<a href="javascript:void(0)" class="add-location"><span><img src="<?=$baseUrl?>/images/addplaceBl.png"></span></a> */ ?>
				
                <a href="javascript:void(0)" class="add-title"><span><img src="<?=$baseUrl?>/images/addtitleBl.png"></span></a>
            </div>
            <div class="post-bholder">
			<button class="btn btn-primary postbtn" type="button" disabled onclick="addDiscussion()"><span class="glyphicon glyphicon-send"></span>Post</button>
                ...
                <input type="hidden" name="share_setting" id="share_setting" value="Disable"/>
