                                    				...
                                    				<div class="frow tagged_frd_lbl">
                                    					...
                                    					<div class="detail-holder">
                                    						<div class="input-field userwall_tagged_usersblock">
                                    							...
                                    							<!-- <input type="text" placeholder="Connections with you in the photo" class="upload-popupJIDS-taggedconnections fullwidth" id="photoTags"/> -->
                                    						</div>
                                    					</div>
                                    				</div>
                                    			</div>
...
<div class="valign-wrapper additem_modal_footer modal-footer">
    ...
    <a href="javascript:void(0)" class="btngen-center-align waves-effect" onclick="temp()">Upload</a>
</div>
<?php 
exit;
