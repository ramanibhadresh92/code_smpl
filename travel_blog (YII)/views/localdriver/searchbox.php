          ...
          <div class="tab-pane fade active in" id="find-traveller">
             <div class="srow">
            	...
            	<div class="srow" id="checkallsearchdiv">	
					...
					<ul>
						<li>
							<input type="checkbox" id="has_photo" name="localdriverInfo" value="hasphoto">
							<label for="has_photo">Has photo</label>
						</li>
						<li>
							<input type="checkbox" id="has_verified" name="localdriverInfo" value="verified">
							<label for="has_verified">Verified</label>
						</li>
						<li>
							<input type="checkbox" id="has_references" name="localdriverInfo" value="refrence">
