		                  ...
		                  <div class="tab-content view-holder">
		                     <div class="local-heading">
		                        <div class="row mx-0 valign-wrapper">
		                           <div class="left">
		                              <h3 class="heading-inner">LOCAL DRIVERS <span class="lt">(<?=count($posts)?>)</span></h3>
		                              <p class="para-inner">Hire a local driver and enjoy your tour</p>
		                           </div>
		                           <div class="right ml-auto">
		                           		<a href="javascript:void(0)" class="composeTbPostActionlocaldriver createDriverAction <?=$checkuserauthclass?>">
		                     ...
		                     <div class="page-details travelbuddy-details">
		                        ...
		                        <div class="new-post-mobile clear composeTbPostActionlocaldriver createDriverAction <?=$checkuserauthclass?>">
