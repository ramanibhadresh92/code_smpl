...
<div class="modal_content_container">
  <div class="modal_content_child modal-content">
     <div class="popup-title ">
        ...
        <a type="button" class="item_done crop_done hidden_close_span custom_close waves-effect" href="javascript:void(0)" onclick="editpostsave('<?=$postId?>')">Done</a>
     </div>
                             ...
                             <div class="form-box">
                                   ...
                                   <div class="frow">
                                      ...
                                      <div class="detail-holder">
                                         <div class="input-field">
                                            <input type="text" id="editlocaldriver_vehicletype" placeholder="i.e Toyata van with air condition" class="fullwidth locinput " value="<?=$vehicletype?>" />
                                         </div>
                                      </div>
                                   </div>
                                </div>
                                <div class="fulldiv">
                                   <div class="frow">
                                      ...
                                      <div class="detail-holder">
                                         <div class="input-field">
                                            <input type="text" id="editlocaldriver_onboard" placeholder="i.e fresh water bottles, cooler, charger..." class="fullwidth locinput " value="<?=$onboard?>"/>
                                         </div>
                                      </div>
                                   </div>
                                </div>
                                <div class="fulldiv">
                                   <div class="frow">
                                      ...
                                      <div class="detail-holder">
                                         <div class="input-field">
                                            <input type="text" id="editlocaldriver_vehiclecapacity" placeholder="From 1 to 6 people i.e six travellers " value="<?=$vehiclecapacity?>"/>
                                         </div>
                                      </div>
                                   </div>
                                </div>
                                <div class="fulldiv">
                                   <div class="frow">
                                      ...
                                      <div class="detail-holder">
                                         <div class="input-field">
                                            <input type="text" id="editlocaldriver_restriction" placeholder="i.e things that you can not do" value="<?=$restriction?>"/>
                                         </div>
                                      </div>
                                   </div>
                                </div>
                                <div class="fulldiv">
                                   <div class="frow">
                                      ...
                                      <div class="detail-holder">
                                         <div class="input-field">
                                            <input type="text" id="editlocaldriver_describeyourtalent" placeholder="Tell people about your talent" value="<?=$describeyourtalent?>"/>
                                         </div>
                                      </div>
                                   </div>
                                </div>
                                         ...
                                         <div class="frow">
                                            ...
                                            <div class="detail-holder custom-hireaguide dropdown782">
                                               ...
                                               <div class="input-field input-field1 dropdown782">
                                                  <select data-fill="n" data-action="hireguideevent" data-selectore="hireguideeventname" id="editlocaldriver_activity" class="eventname hireguideeventname localdrivereventname" multiple>
                                                    <?php 
                                            ...
                                            <div class="col l6 m8 s12">
                                               <div class="detail-holder">
                                                  <div class="input-field dropdown782">
                                                     <select id="editlocaldriver_rate" class="feedrp" data-selectore="feedrp" data-fill="n" data-action="fee">
                                                        <option value="" disabled>Choose Fee</option>
                                                        <?php
                                                        foreach ($rates as $key => $s8032n) {
                                                          if($rate == $key) {
                                                            echo "<option value=".$key." selected>$s8032n</option>";
                                                          } else {
                                         ...
                                         <div class="post-photos new_pic_add">
                                            <div class="img-row">
	                                            ...
	                                            foreach ($images as $images_s){
	                                                ...
	                                                $uniqid = $unid.'_'.$rand;
	                                                ?>
	                                                <div class="img-box"><img src="<?=$images_s?>" class="upldimg thumb-image vimg"><div class="loader" style="display: none;"></div><a href="javascript:void(0)" onclick="removepiclocaldriver_modal('<?=$postId?>', this)" class="removePhotoFilelocalguide"><i class="mdi mdi-close"></i></a></div>
...
<div class="valign-wrapper additem_modal_footer modal-footer">
  ...
  <a href="javascript:void(0)" class="btngen-center-align waves-effect" onclick="editpostsave('<?=$postId?>')">Publish</a>
</div>	
<?php }  
exit;