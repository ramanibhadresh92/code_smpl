...
if(isset($posts) && !empty($posts)) { 
	foreach ($posts as $key => $value) {
            ...
            $name = $value['fullname'];
            $creprodesc = preg_replace('/\s+/S', " ", $value['creprodesc']);
	...
	?>
	<div class="post-holder localdriver-post bshadow postid_<?=$postId?>">
	    <div class="post-topbar">
	        <div class="post-userinfo">
	            ...
	            <div class="desc-holder">
	                <a href="javascript:void(0)"><?=$name?></a> is <span>Local Driver</span> in <span class="etext"><?=$address?></span>
	        ...
	        <div class="post-details">
	            ...
	            <div class="content-holder mode-holder">
	                <div class="normal-mode">
	                    <div class="post-desc">
	                        <p class="dpara"><i class="mdi mdi-format-quote-open"></i><?=$creprodesc?></p>                         
	                    </div>
	                    <div class="drow">
	                    ...
	                    <div class="drow">
	                        <div class="caption-holder">Driver Fees</div>
