...
<script src="<?=$baseUrl?>/js/chart.js"></script>
				                            ...
				                            <div class="row cshfsiput cshfsi">
				                                ...
				                                <div class="postBox">
				                                    <div class="content-box ">
				                                        <div class="new-post base-newpost cshfsiput cshfsi compose_newtrip <?=$checkuserauthclass?>">
																...
																foreach($tips as $post) {
																	if(($lpDHSU%8) == 0) {  
																		...
																		if(isset($ads) && !empty($ads))
																		{
																			...
																			$this->context->display_last_tip($ad_id, $existing_posts, '', $cls,'','','',$lpDHSU);
																		}
																	}
																	$this->context->display_last_tip($post['_id'],'from_save','','tippost-holder bborder ');
																	$lpDHSU++; 
																}
															} else {
	...
	<script src="<?=$baseUrl?>/js/tips.js"></script>
	<?php $this->endBody() ?> 